/*---------------------------------------------------------------------------*\
  File: electronDDSolidSurfaceFluxFvPatchScalarField.C
  Part of: foamPlasmaToolkit
  Developed using the OpenFOAM framework and linked against OpenFOAM libraries.

  Description:
    Implementation of Foam::electronDDSolidSurfaceFluxFvPatchScalarField.
...
#include "electronDDSolidSurfaceFluxFvPatchScalarField.H"
...
(
    fvPatchScalarField,
    electronDDSolidSurfaceFluxFvPatchScalarField
);

// * * * * * * * * * * * * Protected Member Functions  * * * * * * * * * * * //

tmp<scalarField> electronDDSolidSurfaceFluxFvPatchScalarField::calcWallVelocity
(
...
electronDDSolidSurfaceFluxFvPatchScalarField
(
    const electronDDSolidSurfaceFluxFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
void electronDDSolidSurfaceFluxFvPatchScalarField::updateCoeffs()
{
    if (this->updated())
    {
        return;
    ...
    if (enableSEE_ && !mapped_)
    {
        ...
        else
        {
            ...
            ddSolidSurfaceFluxFvPatchScalarField::updateCoeffs();
            return;
        }
    }
...
void electronDDSolidSurfaceFluxFvPatchScalarField::write(Ostream& os) const
{
