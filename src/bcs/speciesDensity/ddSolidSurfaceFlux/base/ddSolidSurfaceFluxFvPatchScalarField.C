/*---------------------------------------------------------------------------*\
  File: ddSolidSurfaceFluxFvPatchScalarField.C
  Part of: foamPlasmaToolkit
  Developed using the OpenFOAM framework and linked against OpenFOAM libraries.

  Description:
    Implementation of Foam::ddSolidSurfaceFluxFvPatchScalarField.
...
defineTypeNameAndDebug(ddSolidSurfaceFluxFvPatchScalarField, 0);

// * * * * * * * * * * * * Protected Member Functions  * * * * * * * * * * * //

//- Thermal velocity for a single constant temperature (dimensionedScalar)
dimensionedScalar ddSolidSurfaceFluxFvPatchScalarField::calcThermalVelocity
(
...
tmp<scalarField> ddSolidSurfaceFluxFvPatchScalarField::calcThermalVelocity
(
    const dimensionedScalar& m,
    const scalarField& T
) const
...
ddSolidSurfaceFluxFvPatchScalarField::ddSolidSurfaceFluxFvPatchScalarField
(
    const fvPatch& p,
...
ddSolidSurfaceFluxFvPatchScalarField::ddSolidSurfaceFluxFvPatchScalarField
(
    const ddSolidSurfaceFluxFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
// void ddSolidSurfaceFluxFvPatchScalarField::updateCoeffs()
// {
//     if (updated()) return;
...
void ddSolidSurfaceFluxFvPatchScalarField::write(Ostream& os) const
{
